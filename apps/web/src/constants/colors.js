...
export const PLANNING_SECTIONS = {
  ...
  prep_locations: {
    label: 'Préparations Locations',
    emoji: '📦',
    color: '#f59e0b',
    affaireOnly: true,
  },
  prep_prestations: {
    label: 'Préparations Prestations',
    emoji: '🎤',
    color: '#3b82f6',
    affaireOnly: true,
  },
  ...
  prep_installations: {
    label: 'Préparations Installations',
    emoji: '⚙️',
    color: '#8b5cf6',
    affaireOnly: true,
  },
  prep_tournees: {
    label: 'Préparations Tournées',
    emoji: '🚐',
    color: '#ec4899',
    affaireOnly: true,
  },
...
// ─── Palette de sélection (ManagementPanel : modules, statuts, équipes) ─
// 40 teintes Tailwind organisées par famille pour offrir un choix
// homogène à l'utilisateur. À utiliser uniquement comme valeurs
// de saisie, pas comme tokens de thème.
export const MANAGEMENT_PALETTE = [
  // Bleus
  '#3b82f6',
  '#2563eb',
  '#1d4ed8',
...
export const getSectionColor = (key) => PLANNING_SECTIONS[key]?.color || STATUS_COLORS.neutral;
