...
const VehicleCell = ({ vehicle, maintenances, onVehicleClick, onVehicleDoubleClick }) => {
  ...
  return (
    ...
    >
      <div className="vehicle-color" style={{ backgroundColor: vehicle.displayColor || vehicle.color || STATUS_COLORS.info }} />
...
const CalendarVehicleColumn = ({
  vehicleGroups, collapsedSections, setCollapsedSections,
  availabilityCount, maintenances,
  onVehicleClick, onVehicleDoubleClick,
}) => (
