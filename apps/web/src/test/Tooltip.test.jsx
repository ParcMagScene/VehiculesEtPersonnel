...
describe('Tooltip', () => {
  ...
  it('shows tooltip on mouseEnter after delay', () => {
    render(<Tooltip content="Info" delay={200}>Hover me</Tooltip>);
  ...
  it('hides tooltip on mouseLeave', () => {
    render(<Tooltip content="Info" delay={0}>Hover me</Tooltip>);
    fireEvent.mouseEnter(screen.getByText('Hover me'));
  ...
  it('applies position class', () => {
    render(<Tooltip content="Info" position="bottom" delay={0}>Hover me</Tooltip>);
    fireEvent.mouseEnter(screen.getByText('Hover me'));
    act(() => { vi.advanceTimersByTime(0); });
  ...
  it('merges custom className', () => {
    const { container } = render(<Tooltip content="X" className="custom">Text</Tooltip>);
