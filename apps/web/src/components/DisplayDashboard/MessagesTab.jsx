  ...
  if (messages.length === 0) {
    return (
      <EmptyState
        ...
        title="Aucun message"
        description="Créez des messages ou annonces à afficher sur vos écrans."
      />
    );
  }
    ...
    <div className="display-list">
      {messages.map((msg) => {
        ...
        return (
          <div
            key={msg.id}
            className={`display-list-item ${!msg.is_active || isExpired ? 'inactive' : ''}`}
          >
            ...
            <div className="list-item-content">
              <h4>
                ...
                <span
                  ...
                  style={{ backgroundColor: prio.color, color: '#fff' }}
                >
                  {prio.label}
                </span>
              </h4>
              ...
              <div className="list-item-meta">
                {msg.date_start && (
                  <span>
                    <Clock size={12} /> Du {formatDateSimple(msg.date_start)}
                  </span>
                )}
                {msg.date_end && <span>au {formatDateSimple(msg.date_end)}</span>}
