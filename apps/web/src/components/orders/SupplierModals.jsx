...
import { X, Check, Plus, Building2, Package, BookOpen, FileText, Layers, ShoppingCart, Hash, FileDown, Receipt, CheckCircle, Clock, ClipboardList } from 'lucide-react';
import { Button, Input, Textarea, Select, EntityCombobox, Spinner, SearchBar, Table, StatusBadge, ProgressBar, Tag, Tooltip } from '@/design-system';
import { formatCurrency, formatDateSimple as formatDate } from '../../utils/formatUtils';
import PhoneInput from '../PhoneInput';
import AddressAutocomplete from '../AddressAutocomplete';
import { useToast } from '../../hooks/useToast';
import api from '../../utils/api';
import { ORDER_STATUS, QUOTE_STATUS, DOC_TYPES, DESTINATIONS, REQUEST_PRIORITY } from './ordersConstants';
...
export const SupplierDetailModal = React.memo(({ data, onClose, onViewOrder, onReload, currentUser }) => {
