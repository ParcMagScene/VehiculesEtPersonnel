...
export default function BLMultiImportModal({ onClose, onImported, defaultAffaireType }) {
  ...
  return (
    <Modal open={true} onClose={onClose} size="xl" className="bl-multi-import-modal">
      <ModalHeader icon={<PackagePlus size={20} />} onClose={onClose}>
        Import BL / BP
      </ModalHeader>
      <ModalBody>
        {/* Drop zone */}
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                ...
                                <span className={`detail-section-chevron ${isOpen ? 'open' : ''}`}>
                                  ▸
                                </span>
                              </div>
