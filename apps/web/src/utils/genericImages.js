...
const KEYWORD_MATCH = [
  ...
  {
    keywords: ['élingue acier', 'elingue acier', 'cable acier'],
    path: 'structure',
    key: 'elingueAcier',
  },
  {
    keywords: ['élingue ronde', 'elingue ronde', 'sangle', 'dyneema'],
    path: 'structure',
    key: 'elingueRonde',
  },
  ...
  // Vidéo
  {
    keywords: ['vidéoprojecteur', 'videoprojecteur', 'vp ', 'beamer'],
    path: 'video',
    key: 'videoprojecteur',
  },
  ...
  {
    keywords: ['pied réglable', 'pied reglable', 'vérin'],
    path: 'praticables',
    key: 'piedReglable',
  },
  ...
  // Accessoires
  {
    keywords: ['flightcase', 'flight case', 'flight-case'],
    path: 'accessoires',
    key: 'flightcase',
  },
  {
    keywords: ['coffret élec', 'coffret elec', 'armoire élec'],
    path: 'accessoires',
    key: 'coffretElec',
  },
