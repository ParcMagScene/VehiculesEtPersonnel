...
import { X, Edit2, Send, Check, Package, ArrowRight, Eye, Building2, Hash, FileText, FileCheck, BookOpen, ClipboardList, Users as UsersIcon, Trash2 } from 'lucide-react';
...
import { ORDER_STATUS, QUOTE_STATUS, REQUEST_STATUS, REQUEST_PRIORITY, groupItemsByRequester } from './ordersConstants';
import { STATUS } from '../../constants';

// ═══ Volet latéral Commande (clic simple) ═══
export const OrderSlidePanel = React.memo(({ order, onClose, onOpenDialog, onEdit, onDelete, onStatusChange }) => {
...
export const QuoteSlidePanel = React.memo(({ quote, onClose, onOpenDialog, onEdit, onDelete, onConvert }) => {
...
export const RequestSlidePanel = React.memo(({ request, onClose, onOpenDialog, isAdmin, onValidate, onEdit }) => {
