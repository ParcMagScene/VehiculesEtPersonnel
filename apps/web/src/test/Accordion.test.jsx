...
describe('Accordion', () => {
  ...
  it('mode contrôlé respecte la prop open', () => {
    const { rerender } = render(
      <Accordion title="Section" open={false}>
        Contenu
      </Accordion>,
    );
    expect(screen.queryByText('Contenu')).not.toBeInTheDocument();
    ...
    rerender(
      <Accordion title="Section" open={true}>
        Contenu
      </Accordion>,
    );
    expect(screen.getByText('Contenu')).toBeInTheDocument();
  ...
  it("affiche l'icône si fournie", () => {
    render(
      <Accordion title="Section" icon={<span data-testid="icon">★</span>}>
        Contenu
      </Accordion>,
    );
  ...
  it('applique className supplémentaire', () => {
    const { container } = render(
      <Accordion title="Section" className="custom">
        Contenu
      </Accordion>,
    );
