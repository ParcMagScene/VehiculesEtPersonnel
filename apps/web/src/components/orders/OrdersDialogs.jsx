...
import { X, Edit2, Trash2, Send, Check, Package, ArrowRight, Hash, FileCheck, ClipboardList, Users as UsersIcon } from 'lucide-react';
...
export const OrderDetailDialog = React.memo(({ order, onClose, onEdit, onDelete, onStatusChange }) => {
...
export const QuoteDetailDialog = React.memo(({ quote, onClose, onEdit, onDelete, onConvert, onStatusChange }) => {
...
export const RequestDetailDialog = React.memo(({ request, onClose, isAdmin, onValidate, onDelete, onEdit }) => {
