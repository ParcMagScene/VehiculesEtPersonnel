...
// Modales et panels d'impression : chargement différé (rendus uniquement
// sur action utilisateur — réduit le chunk principal EquipmentPanel).
const SavImportModal = lazy(() => import('../sav/SAVManagerModal'));
const DepotMap = lazy(() => import('../vehicles/DepotMap'));
const DepotMapFocused = lazy(() => import('../vehicles/DepotMapFocused'));
...
const EquipmentImportModal = lazy(() => import('./EquipmentImportModal'));
const LabelsPrintPanel = lazy(() => import('./LabelsPrintPanel'));
    ...
    <Suspense fallback={null}>
      <div className="equipment-panel">
        ...
        <EquipmentDetailDialog
          ...
          onPrintSheet={
            isMobile ? undefined : (eq) => printEquipmentSheet(eq, photosList, logosList)
          }
        ...
        {showReportModal && (
          <MaintenanceReportModal isOpen onClose={() => setShowReportModal(false)} />
        )}
                ...
                {mgmtTab === 'imports' && (
                  <>
                    <div className="eq-management-section">
                      ...
                      <p>
                        Importez votre inventaire depuis un fichier CSV (format Locmat ou
                        équivalent). Les familles, catégories et types seront automatiquement créés.
                      </p>
                      <Button
                        variant="primary"
                    ...
                    <div className="eq-management-section">
                      ...
                      <p>
                        Importez les interventions SAV depuis un fichier CSV Locmat. Les
                        interventions seront automatiquement liées aux équipements via leur numéro
                        de série.
                      </p>
                      <Button
                        variant="primary"
