...
// Les logos .png sont les vrais logos officiels (og:image / apple-touch-icon
// telecharges depuis les sites des stations). Les .svg restants (radiomeuh,
// europe1, tsfjazz, virgin) sont des placeholders ou des logos vectoriels natifs.
const KNOWN_RADIO_LOGOS = {
  radiomeuh: '/radio-logos/radiomeuh.svg',
  fip: '/radio-logos/fip.png',
  franceinter: '/radio-logos/franceinter.png',
  'france inter': '/radio-logos/franceinter.png',
  franceinfo: '/radio-logos/franceinfo.png',
  'france info': '/radio-logos/franceinfo.png',
  franceculture: '/radio-logos/franceculture.png',
  'france culture': '/radio-logos/franceculture.png',
  francemusique: '/radio-logos/francemusique.png',
  'france musique': '/radio-logos/francemusique.png',
  nova: '/radio-logos/nova.png',
  'radio nova': '/radio-logos/nova.png',
  rtl: '/radio-logos/rtl.png',
  nrj: '/radio-logos/nrj.png',
  nostalgie: '/radio-logos/nostalgie.png',
  rfm: '/radio-logos/rfm.png',
  skyrock: '/radio-logos/skyrock.png',
  cherie: '/radio-logos/cheriefm.png',
  chérie: '/radio-logos/cheriefm.png',
  rmc: '/radio-logos/rmc.png',
  ...
  'jazz radio': '/radio-logos/jazzradio.png',
  jazzradio: '/radio-logos/jazzradio.png',
  mouv: '/radio-logos/mouv.png',
  'oui fm': '/radio-logos/ouifm.png',
  ouifm: '/radio-logos/ouifm.png',
  rtl2: '/radio-logos/rtl2.png',
  virgin: '/radio-logos/virgin.svg',
  funradio: '/radio-logos/funradio.png',
  'fun radio': '/radio-logos/funradio.png',
  'rire et chansons': '/radio-logos/rireetchansons.png',
  'sud radio': '/radio-logos/sudradio.png',
};
