...
import { Hash, Edit2, Trash2, ArrowRight, Building2, Package, Check, X, ClipboardList, BookOpen, Users as UsersIcon } from 'lucide-react';
...
// ═══ Liste des commandes ═══
export const OrdersList = React.memo(({ orders, onView, onDoubleClick, onEdit, onDelete, selectedId }) => {
...
// ═══ Liste des devis ═══
export const QuotesList = React.memo(({ quotes, onView, onDoubleClick, onEdit, onDelete, onConvert, selectedId }) => {
...
export const EnhancedSuppliersList = React.memo(({ suppliers, onEdit, onDelete, onClick, onDoubleClick, selectedId }) => {
...
export const MaterialRequestsList = React.memo(({ requests, isAdmin, isSimpleUser, onValidate, onDelete, onClick, onDoubleClick, selectedId }) => {
