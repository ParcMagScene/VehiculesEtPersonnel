...
export const personSchema = z.object({
  ...
  photo: optStr(1000),
  notes: optStr(5000),
  license_types: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  certifications: z.union([z.string(), z.array(z.any())]).optional().nullable(),
  skills: z.union([z.string(), z.array(z.any())]).optional().nullable(),
