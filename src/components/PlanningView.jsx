...
function PlanningView({ 
  ...
  useEffect(() => { loadPersonnelPlanning(); }, [loadPersonnelPlanning]);
  ...
  const getUnavailabilitiesForPersonDay = useCallback((personId, day) => {
    const dayStr = format(day, 'yyyy-MM-dd');
                          ...
                          {missions.map(mission => (
                            ...
                            >
                              ...
                              <div className="planning-mission-info">
                                <div className="planning-mission-type" style={{ color: getMissionColor(mission.type) }}>
                                  {getMissionLabel(mission.type)}
                                </div>
                                {mission.client_name && (
                                  <div className="planning-mission-client">
                                    {mission.client_name}
                                  </div>
                                )}
                                {mission.location && (
                                  <div className="planning-mission-location">
                                    {mission.location}
                                  </div>
                                )}
                              </div>
