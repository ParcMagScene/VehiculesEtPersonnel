...
export function registerInventoryMethods(ApiClient) {
  Object.assign(ApiClient.prototype, {
    ...
    async updateInventoryLocation(id, data) {
      return this.request(`/inventory/locations/${id}`, {
        method: 'PUT',
        body: JSON.stringify(data),
        skipCamelCase: true,
      });
    ...
    async addItemPrice(data) {
      return this.request('/inventory/prices', {
        method: 'POST',
        body: JSON.stringify(data),
        skipCamelCase: true,
      });
    ...
    async getBatchPriceAnalysis(itemIds) {
      return this.request('/inventory/price-engine/batch', {
        method: 'POST',
    ...
    async fusionPrices(stockItemId, prices) {
      return this.request('/inventory/price-engine/fusion', {
        method: 'POST',
        body: JSON.stringify({ stock_item_id: stockItemId, prices }),
        skipCamelCase: true,
      });
    },
    ...
    async updateAnomaly(id, data) {
      return this.request(`/inventory/anomalies/${id}`, {
        method: 'PUT',
        body: JSON.stringify(data),
        skipCamelCase: true,
      });
