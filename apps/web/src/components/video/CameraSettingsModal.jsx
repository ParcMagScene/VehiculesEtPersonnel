      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="form-row">
            ...
            <div className="form-group form-group--inline">
              <label>
                <Checkbox checked={form.ptzSupported} onChange={e => handleChange('ptzSupported', e.target.checked)} />
                PTZ supporté
              </label>
              <label>
                <Checkbox checked={form.enabled} onChange={e => handleChange('enabled', e.target.checked)} />
                Activée
              </label>
            </div>
          </div>
