...
export function registerAnnuaireMethods(ApiClient) {
  Object.assign(ApiClient.prototype, {
    ...
    async createAnnuaireClient(data) {
      return this.request('/annuaire/clients', { method: 'POST', body: JSON.stringify(data), skipCamelCase: true });
    },
    async updateAnnuaireClient(id, data) {
      return this.request(`/annuaire/clients/${id}`, { method: 'PUT', body: JSON.stringify(data), skipCamelCase: true });
    },
    ...
    async createAnnuaireSupplier(data) {
      return this.request('/annuaire/suppliers', { method: 'POST', body: JSON.stringify(data), skipCamelCase: true });
    },
    async updateAnnuaireSupplier(id, data) {
      return this.request(`/annuaire/suppliers/${id}`, { method: 'PUT', body: JSON.stringify(data), skipCamelCase: true });
    },
    ...
    async createAnnuairePrestataire(data) {
      return this.request('/annuaire/prestataires', { method: 'POST', body: JSON.stringify(data), skipCamelCase: true });
    },
    async updateAnnuairePrestataire(id, data) {
      return this.request(`/annuaire/prestataires/${id}`, { method: 'PUT', body: JSON.stringify(data), skipCamelCase: true });
    },
    async deleteAnnuairePrestataire(id) {
      return this.request(`/annuaire/prestataires/${id}`, { method: 'DELETE', skipCamelCase: true });
    },
    ...
    async createAnnuaireContact(data) {
      return this.request('/annuaire/contacts', { method: 'POST', body: JSON.stringify(data), skipCamelCase: true });
    },
    async updateAnnuaireContact(id, data) {
      return this.request(`/annuaire/contacts/${id}`, { method: 'PUT', body: JSON.stringify(data), skipCamelCase: true });
    },
    ...
    async createAnnuaireRef(slug, data) {
      return this.request(`/annuaire/ref/${slug}`, { method: 'POST', body: JSON.stringify(data), skipCamelCase: true });
    },
    async updateAnnuaireRef(slug, id, data) {
      return this.request(`/annuaire/ref/${slug}/${id}`, { method: 'PUT', body: JSON.stringify(data), skipCamelCase: true });
    },
    ...
    async searchAnnuaire(query) {
      return this.request(`/annuaire/search?q=${encodeURIComponent(query)}`, { skipCamelCase: true });
    },
    ...
    async importSuppliersCsv() {
      return this.request('/annuaire/import/suppliers-csv', { method: 'POST', skipCamelCase: true });
    },
    async importContactsCsv(data, mode = 'import') {
      return this.request('/annuaire/import/contacts-csv', { method: 'POST', body: JSON.stringify({ data, mode }), skipCamelCase: true });
    },
  });
}
